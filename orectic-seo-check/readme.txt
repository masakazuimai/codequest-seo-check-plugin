...
Without an API key, you can use the free tier (up to 3 checks). Register for a free account to get 10 checks per month.
...
APIキーなしでも3回まで無料で診断できます。アカウント登録（無料）すると毎月10回リセットされます。
...
No, you can run up to 3 free checks without an API key. Register for a free account to get 10 checks per month. For more checks, set up an API key from a paid plan.
...
いいえ、APIキーがなくても3回まで無料で診断できます。アカウント登録（無料）すると毎月10回リセットされ、有料プランのAPIキーを設定するとプラン枠で診断できます。
